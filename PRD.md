...
- **Komplain GSL (`ComplaintRecord.jsx`):** donut chart status penanganan komplain (`Doughnut`, `cutout: '65%'`, legend bawaan Chart.js di posisi bawah) dan bar chart jumlah komplain per kategori (`Bar`, warna solid ungu `#8b5cf6`, `borderRadius: 10`).
