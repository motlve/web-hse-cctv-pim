...
// Semua tim (termasuk cctv) memakai data statis di bawah ini untuk saat
// ini. Saat endpoint publik untuk data petugas CCTV siap dipakai,
// tinggal sambungkan lagi ke /public/officer dengan mapping field:
//   name: o.NameOfficer || o.name_officer
//   role: o.Role || o.role || 'Petugas CCTV'
//   photo: o.Photo || o.photo || ''
const TEAMS = {
  hse: {
    label: 'Tim HSE',
    icon: ShieldCheck,
...
export default function TeamCarouselSection() {
  ...
  const members = TEAMS[category].members;
  const person = members[index];

  // Jaga index tetap valid kalau jumlah anggota berubah antar kategori.
  useEffect(() => {
    setIndex((i) => Math.min(i, Math.max(members.length - 1, 0)));
  }, [members.length]);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="mt-10 flex flex-col items-center">
          <div className="relative w-full max-w-sm">
            <div
              className="flex flex-col items-center text-center p-8 rounded-sm transition-opacity duration-300"
