        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-6 sm:mt-7 flex flex-wrap items-center gap-3 sm:gap-4">
              <a
                href="#kontak"
                className="inline-flex items-center gap-1.5 text-sm font-medium px-5 py-2.5 sm:py-3 rounded-sm transition-colors"
              ...
              <a
                href="#kebijakan"
                className="text-sm font-medium px-5 py-2.5 sm:py-3 rounded-sm border transition-colors"
          ...
          <div className="relative">
            ...
            >
              <div className="flex flex-col items-center gap-2 px-6 text-center">
                ...
                <p className="text-xs sm:text-sm" style={{ color: '#A8635B' }}>
            ...
            <div
              className="absolute -bottom-5 sm:-bottom-6 -left-4 sm:-left-6 hidden sm:flex items-center gap-3 rounded-sm px-4 py-3 shadow-sm z-10"
