...
const MESSAGE_TYPES = [
  { id: 'umum', icon: HelpCircle, label: 'Pertanyaan Umum' },
  { id: 'insiden', icon: ShieldAlert, label: 'Laporan Insiden' },
  { id: 'kerjasama', icon: Handshake, label: 'Kerja Sama' },
];
        ...
        <div className="mt-12 grid lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            >
              ...
              />
              <div
                className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-full animate-pulse"
                style={{ backgroundColor: 'rgba(74,46,10,0.15)' }}
              >
                {createElement(PhoneCall, {
                  size: 20,
                  strokeWidth: 2,
                  style: { color: '#4A2E0A' },
                })}
                ...
                <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="mt-1.5 w-full rounded-xl px-4 py-2.5 text-sm outline-none resize-none transition-all focus:ring-2 focus:ring-[#6B1414]/10"
                      style={{
